<script lang="ts">
	...
	export let expression = "x^2 - y^2 - 1";
...
<!-- <div class="container">
	<Menu bind:expression {expression_error} {calculate} bind:debug_draw bind:max_depth bind:zero_exclusion_algorithm bind:zero_finding_algorithm {duration}/>
</div>
<div class="container">
